...
class HardAttention(tf.keras.Model):
    ...
    def call(self, features, hidden):
        ...
        context_vector_z = tf.zeros(shape=[1, features.shape[1], features.shape[2], features.shape[3]], dtype=tf.dtypes.float32)
        ...
        for idx, act_greedy in enumerate(batch_greedy):
            ...
            if act_greedy:
                ...
                one_hot_selection = tensorflow_probability.distributions.Multinomial(total_count=1., probs=attention_probs_alpha )
